...
INSERT INTO characters (name, display_name) VALUES 
...
CREATE TABLE run_statistics (
    ...
    PRIMARY KEY (username, profile_name, character_name, period_start, period_end),
...
CREATE INDEX idx_runs_profile_monthly ON runs(username, profile_name, DATE_TRUNC('month', run_timestamp AT TIME ZONE 'UTC'));
